scriptName McmRecorder_PrivateAPI hidden
{This is the *private* API for the MCM Recorder mod.

Please **DO NOT USE ANY OF THE FUNCTIONS PROVIDED HERE**.

Anything in this file is subject to change with any new release of MCM Recorder.

Instead, please rely on the public interface functions provided by McmRecorder.

Functions in this file may not have any documentation!}
...
SKI_ConfigBase function GetMcmInstance(string modName) global
    McmRecorder recorder = GetMcmRecorderInstance()
